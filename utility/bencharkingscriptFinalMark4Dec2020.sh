...
print_USAGE()
{
echo -e "USAGE: bash ./bencharkingscript.sh <CountsTopDir> <ValidatedSTR> <ResultDir> <filename> <FilterThreshold (must be a floating number [0.1-0.9])> <DeleteTemp(yes/no)>\n"
echo "EXAMPLE:"
echo "bash ./bencharkingscript.sh ../Counting ../ValidatedSTR.txt ../ResultsDir Output30_05 0.5 no"
echo -e "\n"
}
